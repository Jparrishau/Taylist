...
<div id="postDetailModal" class="details-modal">
  ...
  <div class="modal-content">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item">
        <img src="{{ asset('img/gallery/furniture/1478983049.jpg') }}" alt="Couch" style="width:100%; height:auto;">
      </div>
    </div>
  ...
  <div class="row" style="max-width:100%; margin:0 1px;">
    ...
    <div class="tab-content">
      <div id="detail_menu" class="tab-pane fade in active">
        ...
        <p id="app"><b>Location:</b> @{{message}}</p>
        <p><b>Asking Price:</b> $0.00</p>
        <p><b>Condition:</b> Filler</p>
        <p><b>Description:</b> Lorem ipsum dolor sit amet, consectetur adipiscing elit.z Integer nec odio. Praesent libero.
        ...
        Donec lacus nunc, viverra nec.</p>
      </div>
